...
def ParseArgs():
	...
	parser.add_argument('--tstBat', default=1, type=int, help='number of users in a testing batch')
	...
	parser.add_argument('--hyperNum', default=131, type=int, help='number of hyperedges')
	parser.add_argument('--gnn_layer', default=2, type=int, help='number of gnn layers')
	parser.add_argument('--load_model', default=None, help='model name to load')
	parser.add_argument('--topk', default=20, type=int, help='K of top K')
	parser.add_argument('--keepRate', default=0.2, type=float, help='ratio of edges to keep')
